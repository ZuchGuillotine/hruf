...
declare const DrawerOverlay: React.ForwardRefExoticComponent<
  Omit<
    Omit<
      import('@radix-ui/react-dialog').DialogOverlayProps & React.RefAttributes<HTMLDivElement>,
      'ref'
    > &
...
declare const DrawerContent: React.ForwardRefExoticComponent<
  Omit<
    Omit<
      import('@radix-ui/react-dialog').DialogContentProps & React.RefAttributes<HTMLDivElement>,
      'ref'
    > &
      React.RefAttributes<HTMLDivElement>,
    'ref'
...
declare const DrawerTitle: React.ForwardRefExoticComponent<
  Omit<
    import('@radix-ui/react-dialog').DialogTitleProps & React.RefAttributes<HTMLHeadingElement>,
    'ref'
  > &
