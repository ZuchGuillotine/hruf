...
import { labResults, biomarkerResults, biomarkerProcessingStatus } from '@core/db';
import type { SelectLabResult, InsertBiomarkerResult, SelectBiomarkerResult } from '@core/db';
