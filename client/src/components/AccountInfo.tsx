    ...
    <Card className="mb-6">
      <CardHeader className="flex flex-row items-center justify-between py-3">
        ...
        {!user?.isPro && user?.trialEndsAt && (
          <div className="px-2 py-1 rounded-full text-sm bg-blue-100 text-blue-800">Free Trial</div>
        )}
        {user?.isPro && (
          <div className="px-2 py-1 rounded-full text-sm bg-green-100 text-green-800">Pro</div>
        )}
      </CardHeader>
              ...
              {streakDays > 0 && (
                <div className="mt-4 p-3 bg-blue-50 rounded-lg">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium">Logging Streak: {streakDays} days</span>
                  </div>
                  <div className="mt-2">
                  ...
                  {streakDays >= 14 ? (
                    ...
                    <p className="text-xs text-gray-600 mt-2">
                      Log your supplements for {14 - streakDays} more days to earn 7 extra trial
                      days!
                    </p>
                  )}
                </div>
