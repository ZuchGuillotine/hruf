      ...
      <Card className="max-w-2xl mx-auto border-[#1b4332]">
        <CardContent className="pt-6">
          <p className="text-sm text-foreground/90">
            ...
            analyze our traffic. By clicking "Accept", you consent to our use of cookies. By
            clicking "Decline", only essential cookies will be used. For more information about how
            we use cookies, please read our{' '}
            <Link href="/privacy">
