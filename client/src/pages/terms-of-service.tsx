      ...
      <main className="container mx-auto px-4 py-6 flex-grow">
        <Card className="max-w-4xl mx-auto">
          ...
          <CardContent className="prose prose-green max-w-none">
            ...
            <p>
              Welcome to Stack Tracker ("the Service"), a web application developed to help users
              track their supplement regimen and record any positive or negative effects. By
              accessing or using the Service, you agree to comply with and be bound by these Terms
              of Service ("Terms"). If you do not agree with these Terms, you must not use the
              Service.
            </p>
            ...
            <p>
              ...
              represent and warrant that you are legally capable of entering into binding agreements
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li>
                Record observations about the effects of supplements, including positive and
            ...
            <p>
              ...
              <strong>
                Always consult with a qualified healthcare professional before making changes to
            ...
            <p>
              ...
              and for all activities conducted under your account. Notify us immediately if you
            ...
            <p>
              The Free Tier provides limited access to features of the Service without any charge.
              Users in the Free Tier may not access premium features available to paid users.
            </p>

            <h4 className="text-lg font-medium mt-4 mb-2">b. Paid Tier</h4>
            <p>
              The Paid Tier provides full access to all features of the Service for a subscription
              fee of $21.99 per month, billed monthly. Users who subscribe to the Paid Tier agree to
              the following terms:
            </p>
            <ul className="list-disc pl-6 mb-4">
              <li>
                <strong>Billing:</strong> Subscription fees are billed on a monthly basis. By
                providing your payment information, you authorize us to charge your account the
                monthly subscription fee until canceled.
              </li>
              <li>
                <strong>Cancellation:</strong> You may cancel your subscription at any time. Upon
                cancellation, you will retain access to the Paid Tier until the end of your current
                billing cycle.
              </li>
              <li>
                <strong>Refunds:</strong> Payments for prior billing periods are non-refundable
                unless otherwise granted at the discretion of the company.
              </li>
            </ul>

            <h3 className="text-xl font-semibold mt-6 mb-3">6. Health Disclaimer</h3>
            <p className="font-medium">
              The information provided by the Service is for informational purposes only. The
              Service does not provide medical advice.
            </p>
            <p>
              <strong>
                You should always consult with a healthcare professional before starting, stopping,
                or modifying any supplement or treatment plan.
              </strong>{' '}
              We are not responsible for any harm or adverse effects that may result from your use
              of the Service.
            </p>

            <h3 className="text-xl font-semibold mt-6 mb-3">7. Privacy</h3>
            <p>
              Our Privacy Policy governs how we collect, use, and store your data. By using the
            ...
            <p>
              ...
              text, graphics, logos, and software, are owned by Stack Tracker and are protected by
            ...
            <p>
              To the maximum extent permitted by law, Stack Tracker, its affiliates, and licensors
              shall not be liable for any direct, indirect, incidental, special, or consequential
              damages resulting from your use of the Service. This includes, but is not limited to,
              damages for health-related issues, loss of data, or any other matter relating to the
              Service.
            </p>

            <h3 className="text-xl font-semibold mt-6 mb-3">10. Indemnification</h3>
            <p>
              You agree to indemnify and hold harmless Stack Tracker, its affiliates, and employees
              from and against any claims, damages, or expenses arising out of your use of the
            ...
            <p>
              ...
              notice, for any violation of these Terms or for any other reason at our sole
              discretion.
            </p>
            ...
            <p>
              ...
              updated Terms to the Service. Your continued use of the Service after changes are
            ...
            <p className="mt-2">
              <strong>Email:</strong> support@stacktracker.co
            </p>
