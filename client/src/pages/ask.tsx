...
export default function AskPage() {
  ...
  const { sendQuery, messages, isLoading, error, resetChat, limitReached, resetLimitReached } =
    useQuery();
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Ask any supplement-related questions and get personalized answers based on scientific
              research.
            </p>
          </div>
            ...
            {messages.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 dark:text-gray-500 max-w-md mx-auto">
                  Ask any questions about supplements, their effects, or how they might interact
