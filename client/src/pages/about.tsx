    ...
    <Fragment>
      ...
      <main className="container py-12 max-w-4xl">
        <article className="prose prose-slate dark:prose-invert max-w-none">
          <h1 className="text-3xl font-bold">About StackTracker</h1>
          <p className="text-lg">
          ...
          <h2 className="text-2xl font-bold mt-8">What StackTracker Does</h2>
          <ul>
          ...
          <h2 className="text-2xl font-bold mt-8">Designed for You</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold mt-8">A Healthy Future</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold mt-8">Join the Community</h2>
          <p>
