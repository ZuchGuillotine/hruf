      ...
      <main className="container mx-auto px-4 py-6 flex-grow">
        <Card className="max-w-4xl mx-auto">
          ...
          <CardContent className="prose prose-green max-w-none">
            ...
            <p>
              Stack Tracker ("we," "us," or "our") values your privacy and is committed to
              protecting your personal information. This Privacy Policy outlines how we collect,
              use, and safeguard your information when you use our web application ("the Service").
            ...
            <p>
              You can manage or disable cookies through your browser settings, but doing so may
            ...
            <ul className="list-disc pl-6 mb-4">
              <li>
                <strong>To Provide the Service:</strong> Deliver and maintain the functionality of
                the Service, including user account management.
              </li>
              <li>
                <strong>To Process Payments:</strong> Manage billing for Paid Tier users.
              </li>
              <li>
                <strong>To Improve the Service:</strong> Analyze usage trends and user feedback to
                enhance features and functionality.
              </li>
              <li>
                <strong>To Communicate with You:</strong> Respond to inquiries, provide support, and
                send updates about the Service.
              </li>
              <li>
                <strong>To Ensure Security:</strong> Protect against unauthorized access, fraud, and
            ...
            <ul className="list-disc pl-6 mb-4">
              <li>
                ...
                who help us operate the Service, such as payment processors and analytics providers.
              </li>
              <li>
                <strong>Legal Obligations:</strong> We may disclose information if required to
                comply with legal obligations or to protect our rights and safety.
              </li>
              <li>
            ...
            <ul className="list-disc pl-6 mb-4">
              <li>
                <strong>Access and Correction:</strong> Request access to or correction of your
                personal data.
              </li>
              <li>
              ...
              <li>
                <strong>Opt-Out:</strong> Opt out of certain data collection practices, including
            ...
            <p>
              ...
              privacy practices or content of such websites. We encourage you to review their
            ...
            <p>
              ...
              collect personal information from children. If we become aware that a child under 18
            ...
            <p>
              ...
              this page with an updated "Effective Date." Your continued use of the Service after
